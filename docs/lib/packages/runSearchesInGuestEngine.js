...
import graphlib from './graphlib.mjs';
...
class SearchGuestRealmInputs {
    #baseInputs;
    #graphs;
    #searchConfiguration;
    constructor(baseInputs, graphs, searchConfiguration) {
        this.#baseInputs = baseInputs;
        this.#graphs = graphs;
        this.#searchConfiguration = searchConfiguration;
    }
    get startingSpecifier() {
